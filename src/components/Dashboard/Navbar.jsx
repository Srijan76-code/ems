    ...
    <>
        ...
        <div className='bg-[#101010] w-full h-22 text-white flex justify-between px-16  ' >
            <div className="flex w-[40%] gap-3 items-center ">
                ...
                <img className='h-8 w-8 relative right-[60px] text-[#00D6A2] ' src="./admin-images/search.png" alt="" />

            </div>
            <div className="flex gap-3 items-center">
                <img className='h-14 w-14 shadow-xl rounded-full shadow-black' src="./admin-images/login.png" alt="" />
